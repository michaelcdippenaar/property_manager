---
name: klikk-platform-product-status
description: >
  Managing the Klikk product feature registry (content/product/features.yaml). Check/update
  feature statuses, generate roadmap summaries, mark features shipped, sync changelog.
---
