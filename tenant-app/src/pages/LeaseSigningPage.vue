    ...
    <q-page-container>
      <q-page class="page-container">
        ...
        <div v-else-if="!lease" class="text-center q-pt-xl">
          ...
          <div class="text-weight-semibold text-grey-8">No active lease found</div>
        </div>
        ...
        <template v-else>
          ...
          <template v-if="submissions.length > 0">
            <div class="text-caption text-grey-6 text-uppercase q-mb-xs q-ml-xs letter-spacing-wide">Signing Status</div>
