...
- [x] Android: `drawable-v24/ic_launcher_foreground.xml` and all `mipmap-*/ic_launcher_foreground.png` densities replaced with Klikk-branded assets; background remains Navy `#2B2D6E` — foreground XML rewritten as white-K vector; mipmap PNGs (mdpi→xxxhdpi) generated; values/ic_launcher_background.xml corrected from #FFFFFF to #2B2D6E
