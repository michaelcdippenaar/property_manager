...
Duplicate of RNT-SEC-025, already shipped. `get_permissions()` override locking `dispatch_award`, `dispatch_send`, `job_dispatch` POST to `IsAgentOrAdmin` confirmed; 239 passed, 1 xfailed. Closing as duplicate.
