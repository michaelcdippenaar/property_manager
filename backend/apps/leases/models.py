...
class AILeaseAgentRun(models.Model):
    ...
    # Idempotency / correlation key for the request. Generated by the view
    # (uuid4 or x-request-id header). Indexed + unique so re-tries of a
    # failed dispatch produce a single row.
